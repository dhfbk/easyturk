<template>
    <div>
        <div
            class="md:w-5/6 bg-white shadow-lg rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-4 mx-auto"
        >
            ...
            <div class="-mx-3 md:flex md:flex-col">
                <div class="w-full px-3 mb-4">
                    ...
                    >Nome progetto</label>
                    <input
                        class="appearance-none block w-full bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-2 transition duration-150 ease-in-out focus:outline-none focus:border-gray-500 hover:border-gray-500"
                        id="nome"
                        type="text"
                ...
                <div class="w-full px-3 mb-4">
                    ...
                    <input
                        ...
                        class="appearance-none block w-full bg-gray-100 text-gray-700 border rounded py-3 px-4 mb-2 transition duration-150 ease-in-out focus:outline-none focus:border-gray-500 hover:border-gray-500"
                        id="titolo"
                        type="text"
                        placeholder="Titolo"
                    />
            ...
            <div class="-mx-3 md:flex md:flex-col">
                <div class="w-full px-3 mb-4">
                    ...
                    <input
                        class="appearance-none block w-full sm:max-w-xs bg-gray-100 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-2 transition duration-150 ease-in-out focus:outline-none focus:border-gray-500 hover:border-gray-500"
                        id="ricompensa"
                        type="number"
                        min="0.01"
                        step="0.01"
                ...
                <div class="w-full px-3 mb-4">
                    ...
                    <div class="flex flex-col flex-grow sm:flex-row">
                        ...
                        <div class="relative mt-1 sm:mt-0 sm:ml-2">
                            <select
                                class="block appearance-none w-full bg-gray-100 text-gray-700 border border-gray-200 py-3 px-4 pr-8 rounded transition duration-150 ease-in-out focus:outline-none focus:border-gray-500 hover:border-gray-500"
                                id="selectorTempoMax"
                            >
