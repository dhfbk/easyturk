    ...
    <div class="container mx-auto">
      <div class="mb-2">
        ...
        <div class="flex flex-row justify-start mb-4">
          ...
          <input
            class="appearance-none h-full w-20 rounded border block bg-white border-gray-400 text-gray-700 pl-2 pr-1 py-2 leading-tight focus:bg-white focus:border-blue-500 mr-3"
            type="number"
            id="quantity"
            name="quantity"
            min="10"
          ...
          <div class="relative">
            <select
              class="h-full rounded border block appearance-none w-full bg-white border-gray-400 text-gray-700 py-2 pl-2 pr-12 leading-tight focus:bg-white focus:border-blue-500"
              name="choice"
              id="choice"
          ...
          <button
            class="inline-flex flex-row items-center py-2 px-4 ml-auto rounded transition-colors duration-100 ease-out bg-gray-400 hover:bg-gray-300"
          >
...
export default {
  ...
  methods: {
    ...
    currentPage() {
      for (let i = this.page * this.numPerPage; i < this.page * this.numPerPage + parseInt(this.numPerPage); i++) {
        if (this.data[i]) {
