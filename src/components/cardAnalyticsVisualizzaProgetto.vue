    ...
    <div class="bg-white rounded-md shadow-md p-4 mb-4">
        ...
        <div class="w-full flex justify-start -mt-4" v-if="dati.type == 'HIT'">
            ...
            >
                <button
                    type="submit"
                    class="ripple hover:bg-primary flex-row items-center py-2 px-4 bg-transparent rounded-md transition duration-100 ease-out border-2 border-solid border-primary hover:text-white  focus:outline-none h-full"
                >
                    Go to HITs
                </button>
            </router-link>
