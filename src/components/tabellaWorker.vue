<template>
  <div class="container mx-auto">
    ...
    <router-link to="/workers" v-if="showBtn">
      <button
        type="submit"
        class="py-2 px-4 bg-white mt-4 rounded transition-colors duration-100 ease-out border-2 border-solid border-primary text-gray-800 hover:text-gray-100 hover:bg-primary"
      >
        View all
      </button>
    </router-link>
