<template>
    <div>
        <div class="flex flex-col items-center md:items-end content-center py-2" @change="update()">
            <div class="flex flex-col w-full content-center items-center">
                <div v-if="isGold == 0">
                    <p
                        class="text-teal-500 text-md"
                    >Golden standard CSV hasn't been uploaded</p>
                </div>
                <label
                    for="whatDo"
                    class="font-semibold text-sm md:mr-0 text-left w-full"
