    ...
    <div class="overflow-x-auto">
      <table class="w-full shadow-lg rounded border">
        ...
        <tbody class="bg-white text-center">
          <tr class="border-b border-gray-300 hover:bg-gray-100" v-for="(hit, id) in current" :key="id">
            ...
            <td class="table-cell py-1 border-r border-gray-300">
              <p class="text-sm text-gray-700 font-medium">
                {{ hit.assignments_approved }}
              </p>
            </td>
            <td class="table-cell py-1 border-r border-gray-300">
              <p class="text-sm text-gray-700 font-medium">
                {{ hit.assignments_rejected }}
              </p>
            </td>
            <td class="table-cell py-1 border-r border-gray-300">
              <p class="text-sm text-gray-700 font-medium">
                {{ hit.assignments_available }}
              </p>
            </td>
          </tr>
        </tbody>
      ...
      <div class="grid grid-cols-3 mt-2" v-if="totalData.length > numPerPage">
        <button
          ...
          class="bg-gray-400 md:w-48 w-24 hover:bg-gray-300 py-2 px-4 rounded m-2 place-self-start"
        >
          Previous
        </button>
        <div v-else></div>
        ...
        <button
          ...
          class="bg-gray-400 md:w-48 w-24 hover:bg-gray-300 py-2 px-4 rounded m-2 place-self-end"
        >
          Next
        </button>
        <div v-else></div>
